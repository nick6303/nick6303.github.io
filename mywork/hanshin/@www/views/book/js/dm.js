...
if (deviceWidth < 1040 && deviceWidth >= 688) {
    sW = deviceWidth - 80
    var o = deviceWidth / sW;
    sH = sH * o - 80
} else if (deviceWidth < 688) {
    var o = deviceWidth / sW;
    sW = deviceWidth
    sH = sH * o
}
...
var Book = {
    ...
    all_pages: function() {
        ...
        $('#slider li').click(function(e) {
            ...
            close_overlay();
            $(this).setPage(tmp); //$('#book').turn('page', tmp);
        });
...
var Navigation = {
        ...
        init: function() {
            ...
            $('nav .zoom_auto').on('click',
                function() {
                    Book.zoom_auto();
                    Book.book_position();
                    Book.dragdrop_init();
                }); // Zoom In
            $('nav .zoom_in').on('click',
                function() {
            ...
            $('nav .show_all').on('click',
                    function() {
                        $('#all_pages').addClass('active').css('opacity', 0).animate({
                                opacity: 1
                            },
                            1000);
                        Book.all_pages();
...
$(window).load(function() { //$.mobile.loading('hide');
