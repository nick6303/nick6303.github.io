var $indexSilder = $('.banner .slickImg ul');
...
$($indexSilder).slick({
    ...
    pauseOnHover: false,
    fade: true,
    prevArrow: '.banner .slickImg .slickLeft',
    nextArrow: '.banner .slickImg .slickRight',
});

$('.banner .slickImg ul').on('init', function(event, slick, currentSlide, nextSlide) {
...
$('.banner .slickImg ul').on('afterChange', function(event, slick, currentSlide, nextSlide) {
    $(".loadingBar").addClass("loading");
});
...
$(window).scroll(function() {
    ...
    if ($scrollTop > 75) {
        ...
        if ($videoId = 'video' && $player1 === 1 && !mobile && !is_safari) {　
            player1.pauseVideo();
            $indexSilder.slick('slickPause');
            $(".banner .slickImg .loadingBar.loading").css("animation-play-state", "paused");
        }
        ////////////////////
        //      player2   //
        ////////////////////　
        ...
        if ($videoId = 'video' && $player1 === 1 && !mobile && !is_safari) {　　
            player1.playVideo();
            $indexSilder.slick('slickPause');
            $(".banner .slickImg .loadingBar.loading").css("animation-play-state","running");
        }
        ////////////////////
        //      player2   //
        ////////////////////
...
// $(".open-box").on('click', function(event) {
//     $indexSilder.slick('slickPause');
// });
